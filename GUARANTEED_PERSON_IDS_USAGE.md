...
本功能允许您手动指定特定人员的编号（uid），使其在**每第6次抽奖**时获得保底中奖机会。全局抽奖5次后，第6次抽奖时这些指定人员将被优先选中。
...
### 抽奖1-5次（第7-11次、第13-17次...）
抽奖系统按以下优先级选择：

1. **第一优先级**：自动保底人员（连续未中奖次数达到"保底阈值"的人员）
2. **第二优先级**：从剩余人员池中随机抽取

### 第6次抽奖（第12次、第18次...）⭐
抽奖系统按以下优先级选择：

1. **第一优先级**：手动指定的保底人员（通过"保底人员编号"设置）⭐ 仅第6次生效
2. **第二优先级**：自动保底人员（连续未中奖次数达到"保底阈值"的人员）
3. **第三优先级**：从剩余人员池中随机抽取

**重要**：手动保底人员只在每第6次抽奖（6、12、18、24...）时生效！

## 注意事项

1. **编号必须存在**：输入的人员编号（uid）必须在人员列表中存在，否则会被忽略
2. **仅第6次生效**：手动保底人员只在全局抽奖的第6、12、18次时生效
...
```
- 第1-5次抽奖：正常
- 第6次抽奖：U001、U005 保底中奖 ⭐
- 第7-11次抽奖：正常
- 第12次抽奖：U001、U005 保底中奖 ⭐

### 场景2：补偿机制（等到第6次）
想要补偿某些人员，等到第6次抽奖时自动中奖：
```
输入：U010,U020,U030
```
...
- 结果：
  - 第1-5次：连续未中5次的人自动保底
  - 第6次：U001、U002优先，然后是连续未中5次的人员，最后随机
  - 第7-11次：连续未中5次的人自动保底
  - 第12次：U001、U002优先，然后是连续未中5次的人员，最后随机
