export const tooltipEn = {
    ...
    guaranteedPersonIds: 'Manually specify person IDs (uid) that should be guaranteed to win. Enter multiple IDs separated by commas (e.g., U001,U002,U003). These people will be prioritized in the next lottery.',
...
export const tooltipZhCn = {
    ...
    guaranteedPersonIds: '手动指定保底中奖的人员编号（uid）。输入多个编号时用逗号分隔（例如：U001,U002,U003）。这些人员将在下一次抽奖时被优先选中。',
    uploadImage: '上传图片',
    pleaseGoto: '请先前往',
}
