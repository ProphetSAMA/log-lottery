export const tableEn = {
    ...
    guaranteedMatch: 'Guaranteed Match',
    guaranteedMatchThreshold: 'Guaranteed Threshold',
    guaranteedPersonIds: 'Guaranteed Person IDs',
...
export const tableZhCn = {
    ...
    timedStop: '定时停止',
    playWinMusic: '播放中奖音乐',
    guaranteedMatch: '保底匹配',
    guaranteedMatchThreshold: '保底阈值',
    guaranteedPersonIds: '保底人员编号',
    resetAllData: '重置数据',
    globalFont: '全局字体',
    titleFont: '标题字体',
